    ...
    return (
        <div>
            <Container>
                ...
                <FlagsWrapper>
                    <div>
                        <Flags title="Arabic Emirates" website="shopname.ae" img={emiratesFlag}/>
                        <Flags title="Denmark" website="denmark.com.dk" img={denmark}/>
                    </div>
                    <div>
                    <Flags title="Australia" website="shopname.ae" img={australiaFlag}/>
                        <Flags title="France" website="shopname.com.fr" img={franceFlag}/>
                    </div>
                    <div>
                    <Flags title="United States" website="shopname.ae" img={unitedStateFlag}/>
                    <Flags title="Arabic Emirates" website="shopname.ae" img={emiratesFlag}/>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <Flags title="Great Britain" website="shopname.co.uk" img={britainFlag}/>
                    </div>
                </FlagsWrapper>
            </Container>
        </div>
