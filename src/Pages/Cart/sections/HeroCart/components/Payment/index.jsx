        ...
        <Style>
            ...
            <BorderWrapper style={{boxShadow:" 0px 4px 10px rgba(56, 56, 56, 0.1)",margin:'20px 0'}}>
                <div style={{borderBottom:'1px solid #E4E4E4'}}>
                    <FlexBetween><P>Subtotal:</P> <span>$1403.97</span></FlexBetween>
                    <FlexBetween><P>Discount:</P> <span style={{color:'#FA3434'}}>-$60.00</span></FlexBetween>
                    <FlexBetween><P>Tax:</P> <span style={{color:'#00B517'}}>+$14.00</span></FlexBetween>
                </div>
                <div>
                <FlexBetween><P style={{fontWeight:'600'}}>Total:</P> <Total>$1357.97</Total></FlexBetween>
